...
<nav class="navbar navbar-default">
	<div class="container">
		...
		</div><!--/.nav-collapse --></div></div><center>
<div id="section" style="height: 500px !important"><br><br><br>
	<h2>Welcome <?php echo $_SESSION['firstName']." ".$_SESSION['lastName']; ?></h2>
	<p> Welcome to Online Mobile Store. </p>
</div>
    <div id="footer"><span class="glyphicon glyphicon-copyright-mark" aria-hidden=true></span> mobilestore.com</div>
</center>
